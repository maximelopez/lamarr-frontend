...
/**
 * Icônes de la page Accueil.
 * Les tracés proviennent de Font Awesome Free 6.7.2 (licence CC BY 4.0),
 * inlinés en SVG maison pour éviter d'ajouter une dépendance. Toutes les
 * icônes sont décoratives par défaut (aria-hidden) : le libellé accessible
 * est porté par le bouton/lien qui les contient. La couleur suit
 * `currentColor` afin de rester pilotable via les tokens Tailwind (text-*).
 */
...
function Glyph({
  ...
  path,
  ...props
}: IconProps & { viewBox: string; path: string }) {
  return (
    <svg
      viewBox={viewBox}
      fill="currentColor"
...
/** Icône QR code (Font Awesome « qrcode », décorative). */
export const QrDecoration = (props: IconProps) => (
  <Glyph
    {...props}
    viewBox="0 0 448 512"
